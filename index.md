...
> Последнее обновление: 2026-08-29 | Всего страниц: 32
...
- [[screenshot-to-code]] — open-source-инструмент, превращающий скриншоты, Figma-макеты и записи экрана в frontend-код.
...
- [[github-issue-triage]] — значение triage в GitHub Issues: первичный разбор, классификация и маршрутизация тикетов.
...
- [ready-agent-skills-catalog-2026-08-29](raw/articles/ready-agent-skills-catalog-2026-08-29.md) — обновлённая пересланная подборка из 27 готовых скиллов по порядку работы, тексту, дизайну, медиа, разработке, маркетингу и бизнес-задачам.
